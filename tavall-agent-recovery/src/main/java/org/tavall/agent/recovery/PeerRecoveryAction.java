...
/**
 * Typed recovery intents emitted by recovery planning. The agent does not execute these directly;
 * Tavall Cloud/CONTROL must separately authorize and route any concrete mutation.
 */

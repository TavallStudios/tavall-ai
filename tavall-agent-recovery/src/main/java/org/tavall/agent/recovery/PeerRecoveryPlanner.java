...
/**
 * Deterministic first-pass recovery planner. The model may reason over the same evidence, but any
 * concrete mutation still requires a separately authorized Tavall Cloud/CONTROL execution path.
 */
public final class PeerRecoveryPlanner {
    public PeerRecoveryPlan plan(PeerHealthObservation observation) {
        ...
        return new PeerRecoveryPlan(
                ...
                observation.environment() == RecoveryEnvironment.PRODUCTION
